...
* readme: Add device type support clarification [Tomás Migone]
* multi-room: Stop containers if multi-room is disabled [Tomás Migone]
* multi-room: Address code review suggestions [Tomás Migone]
